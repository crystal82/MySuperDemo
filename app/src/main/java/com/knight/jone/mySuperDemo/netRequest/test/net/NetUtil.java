package com.knight.jone.mySuperDemo.netRequest.test.net;

import com.knight.jone.mySuperDemo.netRequest.test.logger.ExceptionLoger;
import com.knight.jone.mySuperDemo.netRequest.test.logger.RequestLogBean;
import com.knight.jone.mySuperDemo.netRequest.test.logger.RequestLoger;
import com.knight.jone.mySuperDemo.netRequest.test.utils.TimeUtil;
...
public class NetUtil {
    ...
    public static Call PostForm(String url, Map<String, String> form, final NetWorkResponseListener responseListener) {
        ...
        Builder formbulider = new Builder();
        for (String key : keys) {
