...
public class CRC8Util {
    ...
    public static void main(String[] args) {
        byte[] bytes = {1, 2, 3, 4, 5, 6, (byte) 0xA1};
        byte[] info = {(byte) 0x88, (byte) 0x88, (byte) 0x88, 0x01, 0x00, 0x00, 0x02, (byte) 0xE8, (byte) 0xE8, 0x03, (byte) 0xFE};
        byte[] info2 = DataDisposeUtil.hexString2ByteArray("88888801000002E8E803FEFE048888058E8E");
        System.out.println(Arrays.toString(DataDisposeUtil.byteArray2IntArray(info2)));
        int b = (calcCrc8(info2));
        int b2 = (calcCrc8(info));
    ...
    public static int[] byteArrayToInt(byte[] bytes) {
        ...
        for (int i = 0; i < 4; i++) {
            int shift = (4 - 1 - i) * 8;
            //往高位游
            int info = (bytes[i] & 0x000000FF) << shift;
            value[i] = info;
        }
        return value;
    }
