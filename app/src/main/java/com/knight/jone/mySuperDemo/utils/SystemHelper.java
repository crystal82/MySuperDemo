...
public class SystemHelper {
     ...
     * 当本应用位于后台时，则将它切换到最前端
     *
     * @param forceReStart true 重新开启，不论是否在后台
     * @param context
     */
    public static void setTopApp(Context context, boolean forceReStart) {
        if (forceReStart || !isRunningForeground(context)) {
            Lg.d("setTopApp", "setTopApp");
            /**获取ActivityManager*/
